...
Markets::Schema::Result::Category
...
L<Markets::Schema::Result::Category> inherits all attributes from L<Markets::Schema::Base::Result> and implements
the following new ones.

=head1 METHODS

L<Markets::Schema::Result::Category> inherits all methods from L<Markets::Schema::Base::Result>
...
L<DBIx::Class::Tree::NestedSet>, L<Markets::Schema::Base::Result>, L<Markets::Schema>
