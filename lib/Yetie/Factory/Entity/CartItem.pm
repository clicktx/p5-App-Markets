...
L<Yetie::Factory::Entity::CartItem> inherits all attributes from L<Yetie::Factory::Entity::LineItem> and implements
the following new ones.

=head1 METHODS

L<Yetie::Factory::Entity::CartItem> inherits all methods from L<Yetie::Factory::Entity::LineItem> and implements
the following new ones.
