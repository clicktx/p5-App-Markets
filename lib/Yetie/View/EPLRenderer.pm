...
Yetie::Renderer::EPLRenderer - Embedded Perl Lite renderer plugin

=head1 SYNOPSIS

  # Mojolicious
  $app->plugin('Yetie::Renderer::EPLRenderer');

  # Mojolicious::Lite
  plugin 'Yetie::Renderer::EPLRenderer';

=head1 DESCRIPTION

forked from L<Mojolicious::Plugin::EPLRenderer> Mojolicious v6.64

L<Yetie::Renderer::EPLRenderer> is a renderer for C<epl> templates, which
...
L<Yetie::Renderer::EPLRenderer> inherits all methods from
L<Yetie::Renderer> and implements the following new ones.
