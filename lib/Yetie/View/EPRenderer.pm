...
Yetie::Renderer::EPRenderer - Embedded Perl renderer plugin

=head1 SYNOPSIS

  # Mojolicious
  $app->plugin('Yetie::Renderer::EPRenderer');
  $app->plugin(Yetie::Renderer::EPRenderer => {name => 'foo'});
  $app->plugin(Yetie::Renderer::EPRenderer => {name => 'bar', template => {line_start => '.'}});

  # Mojolicious::Lite
  plugin 'Yetie::Renderer::EPRenderer';
  plugin Yetie::Renderer::EPRenderer => {name => 'foo'};
  plugin Yetie::Renderer::EPRenderer => {name => 'bar', template => {line_start => '.'}};

=head1 DESCRIPTION

forked from L<Mojolicious::Plugin::EPRenderer> Mojolicious v6.64

L<Yetie::Renderer::EPRenderer> is a renderer for Embedded Perl templates.
...
L<Yetie::Renderer::EPRenderer> supports the following options.
...
L<Yetie::Renderer::EPRenderer> inherits all methods from
L<Yetie::Renderer::EPLRenderer> and implements the following new ones.
