...
L<Yetie::Service::Customers> inherits all attributes from L<Yetie::App::Core::Service> and implements
the following new ones.

=head1 METHODS

L<Yetie::Service::Customers> inherits all methods from L<Yetie::App::Core::Service> and implements
the following new ones.
