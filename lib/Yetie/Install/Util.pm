...
my $MOJO_HOME = Mojo::Home->new->detect('Yetie');
my $MOJO_MODE = Mojolicious->new->mode;

=head1 FUNCTIONS

L<Yetie::Install::Util> implements the following functions, which can be imported individually.
