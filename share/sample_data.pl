(
    ...
    'Address::Phone' => [
        [qw/id address_id number number_only/],
        [ 1, 1, '(305) 939-8498', '3059398498' ],
        [ 2, 1, '(305) 939-8499', '3059398499' ],
        [ 3, 1, '090-1566-3223', '09015663223' ],
        [ 4, 2, '803-767-1849', '8037671849' ],
        [ 5, 3, '804-744-1468', '8047441468' ],
        [ 6, 4, '708-987-1400', '7089871400' ],
        [ 7, 5, '0954-17-2962', '0954172962' ],
    ],
