(
    ...
    'Address' => [
        [qw/id country_code line1 line2 city state postal_code personal_name organization hash/],
        ...
        [ 4, 'us', '906 Pearl Ave.', '', 'Patchogue', 'NY', '11772', 'Albert B. Hastings', 'Twin Food Stores', '49ba623a69d54b84773a710d743cd26c2b3d38ac' ],
        [ 5, 'jp', '北多久町 4-2-4', 'リバーサイド室瀬212', '多久市', '佐賀県', '8460001', '沢井 咲', '株式会社 フィーデザイン', '9e17dd6f9de2d5c1ecad75f70f8615f4c98050f0' ],
    ],
    'Address::Phone::Type' => [
        [qw(id name)],
        [ 1, 'phone' ],
