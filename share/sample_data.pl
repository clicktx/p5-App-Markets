(
    ...
    'Address' => [
        ...
        [ 1, 'us', '42 Pendergast St.', '', 'Piedmont', 'SC', '29673', 'Elizabeth T. Peoples', 'Eli Moore Inc', '3059398498', '2cd6fbf9747c1f9d791942885eaebf2d4cd0d868' ],
        [ 2, 'us', '7004 Tunnel St.', '', 'New Brunswick', 'NJ', '08901', 'Craig M. Hise', 'Big Apple', '8037671849', 'b253e84237954f37eafd4cd0bbfdaffa37e16859' ],
        [ 3, 'us', '803 Wild Rose St.', '', 'Woodstock', 'GA', '30188', 'Mary R. Johnson', '', '8047441468', '72131e5f13601203c39023f020a3821c0b6ccc97' ],
        [ 4, 'us', '906 Pearl Ave.', '', 'Patchogue', 'NY', '11772', 'Albert B. Hastings', 'Twin Food Stores', '7089871400', '49ba623a69d54b84773a710d743cd26c2b3d38ac' ],
        [ 5, 'jp', '北多久町 4-2-4', 'リバーサイド室瀬212', '多久市', '佐賀県', '8460001', '沢井 咲', '株式会社 フィーデザイン', '09054172962', '9e17dd6f9de2d5c1ecad75f70f8615f4c98050f0' ],
    ],
    'Address::Phone::Type' => [
        [qw(id name)],
        [ 1, 'phone' ],
    ...
    'Address::Phone' => [
        [qw/id address_id phone_type_id number number_only/],
        [ 1, 1, 1, '(305) 939-8498', '3059398498' ],
        [ 2, 1, 2, '(305) 939-8499', '3059398499' ],
        [ 3, 1, 3, '090-1566-3223', '09015663223' ],
        [ 4, 2, 1, '803-767-1849', '8037671849' ],
        [ 5, 3, 1, '804-744-1468', '8047441468' ],
        [ 6, 4, 1, '708-987-1400', '7089871400' ],
        [ 7, 5, 1, '0954-17-2962', '0954172962' ],
    ],
